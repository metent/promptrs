 ...
 */
import type { Error, InputStream, OutputStream } from "./wasi-io-streams.d.ts";
import type { Datetime } from "./wasi-clocks-wall-clock.d.ts";
...
export type { Datetime, Error, InputStream, OutputStream };
